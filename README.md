...
Considering the past 12 months (`new`) period and the past 12 months period before that (`old`), we count the number of flags in each period and compute the contrast.
